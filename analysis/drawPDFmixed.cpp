...
void drawVar( const std::string& outdir, TTree* tree, const std::string& var, int nBins, float xMin, float xMax, const std::string& axisName, int legendQuadrant );
...
void drawVar( const std::string& outdir, TTree* tree, const std::string& var, int nBins, float xMin, float xMax, const std::string& axisName, int legendQuadrant ) {
  ...
  tree->Project( hname_q.c_str(), var.c_str(), "w*(abs(partonId)<5)" );
  tree->Project( hname_g.c_str(), var.c_str(), "w*(partonId==21)" );
